...
var app = (function () {
    ...
    /* node_modules/svelte-loading-spinners/dist/SyncLoader.svelte generated by Svelte v3.50.0 */
    const file$1 = "node_modules/svelte-loading-spinners/dist/SyncLoader.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 61, 4, 1491);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 59, 0, 1383);
    		},
    ...
    function create_if_block_1(ctx) {
    	let syncloader;
    	let current;
    	syncloader = new SyncLoader({ $$inline: true });
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			mount_component(syncloader, target, anchor);
    			current = true;
    		},
    		...
    		d: function destroy(detaching) {
    			destroy_component(syncloader, detaching);
    		}
    	};
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			img = element("img");
    			if (!src_url_equal(img.src, img_src_value = /*image_src*/ ctx[0])) attr_dev(img, "src", img_src_value);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*image_src*/ 1 && !src_url_equal(img.src, img_src_value = /*image_src*/ ctx[0])) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(26:1) {#if image_src.length > 0}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let if_block1 = /*image_src*/ ctx[0].length > 0 && create_if_block(ctx);

    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "Philosophy Bot";
    			t1 = space();
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*fetchImage*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	async function fetchImage() {
    		...
    		await fetch("http://127.0.0.1:5000/getimage").then(response => {
    			...
    			$$invalidate(0, image_src = "data:image/jpg;base64," + data.content);
    		});
    	}
    	...
    	return [image_src, loading, fetchImage];
    }
